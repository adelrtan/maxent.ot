...
regularized_model = optimize_weights(data_file, 
...
white_salt_bias_model = optimize_weights(white_salt_data_file,
                                         mu_vector=c(0, 0, 1.3, 3.65),
                                         sigma_scalar=sqrt(0.6))
...
data_file_a <- system.file("extdata", "sample_data_file.txt", package="maxent.ot")
...
# Get paths to toy data file
data_file_b <- system.file("extdata", 
                           "sample_data_file_double_aFreq.txt", 
                           package="maxent.ot")
...
where $R$ is the set of all raw AIC weights of the models p